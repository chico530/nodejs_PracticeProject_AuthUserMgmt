...
router.get("/:email",(req,res)=>{
    // Retrieve the mail parameter from the request URL and send the corresponding friend's details
...
router.put("/:email", (req, res) => {
    ...
    if (friend) { // Check if friend exist
...
router.delete("/:email", (req, res) => {
    ...
    // Send response confirming the deletion of friend
